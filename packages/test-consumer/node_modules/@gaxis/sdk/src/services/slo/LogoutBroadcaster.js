    ...
    async broadcastLogout(userId) {
        ...
        const promises = apps.map(async (app) => {
            ...
            try {
                ...
                this.sdk.events.emitEvent('slo:failure', { applicationId: app.applicationId, error: err.message });
            }
        });

        await Promise.allSettled(promises);
        this.sdk.events.emitEvent('slo:broadcasted', { userId, appCount: apps.length });
    }
}
