...
class SessionManager {
    ...
    async createSession(userId, req = {}) {
        ...
        this.sdk.events.emitEvent(SessionEvents.SESSION_CREATED, { sessionId: sessionPayload.sessionId });
    ...
    async revokeSession(sessionId) {
        const session = await this.registry.update(sessionId, { status: 'REVOKED' });
        this.sdk.events.emitEvent(SessionEvents.SESSION_REVOKED, { sessionId });
    ...
    async destroySession(sessionId) {
        ...
        this.sdk.events.emitEvent(SessionEvents.SESSION_DESTROYED, { sessionId });
