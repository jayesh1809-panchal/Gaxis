  ...
  return async function gaxisHandler(req, res) {
    ...
    if (path === '/login') {
      ...
      res.end(JSON.stringify({
        message: "GAxis Node Provider: Login Endpoint Scaffolded"
      }));
      return true;
    }
    if (path === '/callback') {
      ...
      res.end(JSON.stringify({
        message: "GAxis Node Provider: Callback Endpoint Scaffolded"
      }));
      return true;
    }
    if (path === '/logout') {
      ...
      res.end(JSON.stringify({
        message: "GAxis Node Provider: Logout Endpoint Scaffolded"
      }));
      return true;
    }
