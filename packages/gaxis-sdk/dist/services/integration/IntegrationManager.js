...
class IntegrationManager {
  ...
  async integrate(options = {}) {
    this.sdk.events.emitEvent('integration:started', {
      options
    });
    ...
    try {
      ...
      const {
        application,
        clientSecret
      } = await this.sdk.application.registerApplication(manifest);
      ...
      this.sdk.events.emitEvent('integration:completed', {
  ...
  async repairIntegration(applicationId) {
    ...
    this.sdk.events.emitEvent('integration:repaired', {
      applicationId
    });
  }
